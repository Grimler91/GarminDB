"""Objects representing a database and database objects for storing health data from a TomTom device."""
...
class TomTomDB(utilities.DB):
    """Object representing a database for storing health data from ."""
...
class Attributes(TomTomDB.Base, utilities.KeyValueObject):
    """Object representing generic key-value data from a TomTom device."""
...
class DaysSummary(TomTomDB.Base, utilities.DBObject):
